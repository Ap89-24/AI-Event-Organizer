...
const EventPage = () => {
  ...
  const style = event?.themeColor?.includes("gradient")
    ? { background: event.themeColor } // ✅ gradient
    : {
        backgroundColor: event?.themeColor
          ? darkenColor(event.themeColor, 0.04) // ✅ solid color darken
          : "#1e3a8a", // ✅ fallback
      };

  return (
    <div style={style} className="min-h-screen py-8 pt-6 md:pt-16 lg:mx-5">
      <div className="max-w-7xl mx-auto px-8">
        ...
        {/* Hero Image */}
        {event.coverImage && (
          <div className="relative h-[250px] lg:h-[400px] rounded-2xl overflow-hidden mb-6">
            <Image
        ...
        <div className="grid lg:grid-cols-[1fr_380px] gap-8">
          ...
          <div className="space-y-8">
            {/* Description */}
            <Card className={"pt-0"} style={style}>
          ...
          <div className="lg:sticky lg:top-24 h-fit">
            <Card className={`overflow-hidden py-0`} style={style}>
